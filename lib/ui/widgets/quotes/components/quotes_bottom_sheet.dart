    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          QuotesBottomSheetTile(label: "Trade", onPressed: () {}),
          QuotesBottomSheetTile(label: "Chart", onPressed: () {}),
          QuotesBottomSheetTile(label: "Details", onPressed: () {}),
          QuotesBottomSheetTile(label: "Statistics", onPressed: () {}),
          QuotesBottomSheetTile(label: "Depth of market", onPressed: () {}),
          QuotesBottomSheetTile(label: "Delete", isRed: true, onPressed: () {}),
          verticalSpaceSmall(context),
