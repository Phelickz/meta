...
class MarginBottomSheetCurrencyPair extends StatefulWidget {
  const MarginBottomSheetCurrencyPair({super.key, required this.viewModel});
  final MarginCalculatorViewModel viewModel;

  @override
  State<MarginBottomSheetCurrencyPair> createState() =>
      _MarginBottomSheetCurrencyPairState();
}

class _MarginBottomSheetCurrencyPairState
    extends State<MarginBottomSheetCurrencyPair> {
  @override
