        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Spacer(),
              InkWell(
                onTap: ()=> showBottomSheet(context: context, builder: (_){return ProviderModalBottomsheet.tradeBottomSheet(viewModel);}),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index){
                return PTradeBar(tradeInfo: viewModel.tradeDetailList[index], showExpandedPositionView: viewModel.showExpandedPositionView);
              }))
        ],
    );
  }
