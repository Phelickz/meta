...
class PGraph2 extends StatelessWidget {
  final ProviderViewModel viewModel;
  const PGraph2({super.key, required this.viewModel});
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                LocaleKeys
                    .providerWidget_providerComponent_pGraph2_followersStats,
              ...
              CustomProviderTab(
                  ...
                  fourthTabName: "3M",
                  fifthTabName: "6M",
                  tabIndex: viewModel.followersTabSelectorNotifier.value,
                  onSelectTab: (val) {
          ...
          Expanded(
            ...
            valueListenable: viewModel.followersTabSelectorNotifier,
