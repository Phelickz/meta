  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: viewModel.isDarkMode()?ColorManager.darkHeaderColor:const Color(0xFFFAFDFF),
        border: Border.all(
          color: viewModel.isDarkMode() ? Colors.transparent : const Color(0xFFE4E7EC),
        )
      ),
      child: Column(
          ...
          Row(
            ...
            children: [
              ...
              CustomProviderTab(
                ...
                onSelectTab: (val){viewModel.summaryTwoTabSelectorNotifier.value=val;})
          ...
          return Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(child: quickContainer("Success Rate", "$successRate%", context)),
                  Expanded(child: quickContainer("Gain", "$gain%", context)),
                  Expanded(child: quickContainer("Risk Score", "$riskScore / 10", context)),
                ],
              ),
              Row(
              children: [
    ...
    Widget quickContainer(String title, String subTitle, BuildContext context){
      return Container(
        ...
        padding: EdgeInsets.symmetric(vertical: 8.pHeight(context),horizontal: 8.pWidth(context)),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(8),
            color: viewModel.isDarkMode()?ColorManager.darkHeaderColor:const Color(0xFFECF7FE),
            border: Border.all(color: viewModel.isDarkMode() ? Colors.transparent : const Color(0xFFE4E7EC),
        )
        ),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
