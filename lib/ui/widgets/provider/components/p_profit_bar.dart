...
class ProfitBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(left: 12.5.pWidth(context), right: 12.5.pWidth(context),top: 16.pHeight(context), bottom: 5.pHeight(context)),
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: CustomThemeData.generateColoredStyle(fontSize: 16, context: context, fontWeight: FontWeight.w600, lightTextColor: const Color(0xFF47B0F5), darkTextColor: const Color(0xFF47B0F5)),
                  ),
                ],
              ),
              Column(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: CustomThemeData.generateColoredStyle(fontSize: 13, context: context, fontWeight: FontWeight.w600),
                      ),
                    ],
                  ),
                  // SizedBox(width: 20.pWidth(context),),
                  VerticalDivider(
                    color: viewModel.isDarkMode() ? const Color(0xFF667085) : const Color(0xFFD0D5DD),
                  ),
