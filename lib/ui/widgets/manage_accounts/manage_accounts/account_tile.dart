...
class AccountTile extends StatelessWidget {
  ...
  const AccountTile({super.key, required this.type, required this.email, required this.brokerLogoPath, required this.details, required this.amount});
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: isDarkMode? ColorManager.darkHeaderColor : const Color(0xFFFAFDFF),
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                SizedBox(height: 4.pWidth(context),),
                Text("Balance",
                style: CustomThemeData.generateStyle(
