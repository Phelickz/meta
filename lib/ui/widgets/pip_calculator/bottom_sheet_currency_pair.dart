...
class PipBottomSheetCurrencyPair extends StatefulWidget {
  const PipBottomSheetCurrencyPair({super.key, required this.viewModel});
  final PipCalculatorViewModel viewModel;

  @override
  State<PipBottomSheetCurrencyPair> createState() =>
      _PipBottomSheetCurrencyPairState();
}

class _PipBottomSheetCurrencyPairState
    extends State<PipBottomSheetCurrencyPair> {
  @override
