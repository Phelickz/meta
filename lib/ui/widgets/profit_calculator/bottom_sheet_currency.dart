...
class ProfitBottomSheetCurrency extends StatefulWidget {
  const ProfitBottomSheetCurrency({super.key, required this.viewModel});
  final ProfitCalculatorViewModel viewModel;

  @override
  State<ProfitBottomSheetCurrency> createState() =>
      _ProfitBottomSheetCurrencyState();
}

class _ProfitBottomSheetCurrencyState extends State<ProfitBottomSheetCurrency> {
  @override
