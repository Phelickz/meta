...
class ProfitBottomSheetCurrencyPair extends StatefulWidget {
  const ProfitBottomSheetCurrencyPair({super.key, required this.viewModel});
  final ProfitCalculatorViewModel viewModel;

  @override
  State<ProfitBottomSheetCurrencyPair> createState() =>
      _ProfitBottomSheetCurrencyPairState();
}

class _ProfitBottomSheetCurrencyPairState
    extends State<ProfitBottomSheetCurrencyPair> {
  @override
        ...
        Expanded(
          ...
          child: Container(
            ...
            child: ListView.builder(
              itemCount: widget.viewModel.currencyPair.length,
              itemBuilder: (context, index) {
                return returnTile(
                    widget.viewModel.currencyPair[index],
                    context,
                    widget.viewModel.selectedCurrencyPair ==
                        widget.viewModel.currencyPair[index],
                    true, (p0) {
