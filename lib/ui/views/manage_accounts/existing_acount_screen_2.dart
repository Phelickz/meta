...
class ExistingAccountView2 extends StackedView<ManageAccountViewModel>{
  ...
  Widget builder(BuildContext context, ManageAccountViewModel viewModel, Widget? child) {
    ...
    return Skeleton(
      ...
      appBar: existingAccountAppbar(context, "Login to existing account", "Enter login details"),
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            const ExistingAccountFormView(header1: "Login", header2: "Password", header3: "Server"),
