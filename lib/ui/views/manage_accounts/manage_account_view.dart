          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 160.pHeight(context),),
                  Text("Connect to",
                    style: CustomThemeData.generateStyle(
                      fontSize: McGyver.textSize(context, 2.2),
                      color: CustomThemeData.isDarkMode(context) ? Colors.white : Colors.black,
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index){
                        ...
                        brokerLogoPath: viewModel.brokers_list[index]["brokerImage"], 
